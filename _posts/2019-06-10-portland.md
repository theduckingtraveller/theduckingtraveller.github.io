...
<div style="background: #f8f9fa; border-left: 4px solid #c0334a; padding: 1.5rem; margin: 2rem 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 0.5rem; color: #000;">
    ...
    <div style="padding: 0.5rem 0;">
      <a href="#where-to-eat" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🍽️ Where to Eat & Drink</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#fun-things" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🎉 Fun Things to Do</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#bridal-veil" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">💧 Bridal Veil Falls</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#multnomah" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏞️ Multnomah Falls</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#peculiarium" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">👻 The Peculiarium</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#powell" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">📚 Powell Bookstore</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#lovecraft" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">💀 The LoveCraft Bar</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#union-way" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🛍️ Union Way</a>
    </div>
    <div style="padding: 0.5rem 0; margin-left: 1rem;">
      <a href="#pioneer" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏛️ Pioneer Courthouse Square</a>
    </div>
  </div>
</div>
...
# <a id="where-to-eat"></a>Where to Eat and Drink
...
# <a id="fun-things"></a>Fun Things To Do in Portland

## <a id="bridal-veil"></a>Bridal Veil falls
...
## <a id="multnomah"></a>Multnomah Falls
...
## <a id="peculiarium"></a>The Peculiarium
...
## <a id="powell"></a>Powell Bookstore
...
## <a id="lovecraft"></a>The LoveCraft Bar
...
## <a id="pioneer"></a>Pioneer Courthouse Square
