...
<div style="background: #f8f9fa; border-left: 4px solid #c0334a; padding: 1.5rem; margin: 2rem 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 0.5rem; color: #000;">
    <div style="padding: 0.5rem 0;">
      <a href="#getting-around" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🚗 Getting Around</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#best-time" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">📅 Best Time to Travel</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#things-to-have" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🎒 Things to Have</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#where-to-stay" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏨 Where to Stay</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#anchorage" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏙️ Anchorage</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#seward" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">⛵ Seward</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#exit-glacier" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🧊 Exit Glacier & Harding Ice Field</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#whittier" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏘️ Whittier</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#denali" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏔️ Denali National Park</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#sled-dog" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🐕 Sled Dog Kennel</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#savage-river" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🌊 Savage River Trail</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#polychrome" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🌈 Polychrome Overlook</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#eielson" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏛️ Eielson Visitor Center</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#wonder-lake" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">💎 Wonder Lake</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#talkeetna" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏘️ Talkeetna</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#glacier-landing" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">✈️ Glacier Landing</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#hurricane-train" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🚂 Hurricane Turn Train</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#restaurants" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🍽️ Restaurants</a>
    </div>
  </div>
</div>
...
#### <a id="getting-around"></a>Getting Around
...
#### <a id="best-time"></a>Best Time to Travel
...
#### <a id="things-to-have"></a>Things to have with you
...
## <a id="exit-glacier"></a>Exit Glacier and Harding Ice Field Trail
...
## <a id="denali"></a>Denali National Park
...
### <a id="sled-dog"></a>Sled Dog Kennel
...
### <a id="savage-river"></a>Savage River Trail
...
### <a id="polychrome"></a>Polychrome Overlook
...
### <a id="eielson"></a>Eielson Visitor Center
...
### <a id="wonder-lake"></a>Wonder Lake
...
## <a id="glacier-landing"></a>Glacier Landing
...
## <a id="hurricane-train"></a>Hurricane Turn Train
...
## <a id="restaurants"></a>Restaurants
