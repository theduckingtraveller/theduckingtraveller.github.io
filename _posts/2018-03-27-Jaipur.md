...
<div style="background: #f8f9fa; border-left: 4px solid #c0334a; padding: 1.5rem; margin: 2rem 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 0.5rem; color: #000;">
    <div style="padding: 0.5rem 0;">
      <a href="#city-overview" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏛️ City Overview</a>
    </div>
    <div style="padding: 0.5rem 0;">
    ...
    <div style="padding: 0.5rem 0;">
      <a href="#amer-fort" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏰 Amer Fort/Amber Palace</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#city-palace" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏛️ City Palace</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#hawa-mahal" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏛️ Hawa Mahal</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#jal-mahal" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏛️ Jal Mahal</a>
    </div>
  </div>
</div>
...
## <a id="amer-fort"></a>Amer Fort/ Amber Palace
...
## <a id="city-palace"></a>City Palace
