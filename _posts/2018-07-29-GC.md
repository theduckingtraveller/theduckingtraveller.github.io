...
<div style="background: #f8f9fa; border-left: 4px solid #c0334a; padding: 1.5rem; margin: 2rem 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 0.5rem; color: #000;">
    <div style="padding: 0.5rem 0;">
      <a href="#which-rim" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🗺️ Which Rim to Choose</a>
    </div>
    <div style="padding: 0.5rem 0;">
    ...
    <div style="padding: 0.5rem 0;">
      <a href="#food" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🍽️ Food Inside the Park</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#getting-there" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🚗 How to Get There</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#viewpoints" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏞️ Viewpoints</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#other-activities" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🎯 Other Activities</a>
    </div>
  </div>
</div>
...
### <a id="which-rim"></a>Which RIM to choose!! EAST, WEST, NORTH or SOUTH?
...
### <a id="food"></a>Food inside the park
...
#### <a id="getting-there"></a>How to get here:
...
### <a id="other-activities"></a>Other things that you can do here
