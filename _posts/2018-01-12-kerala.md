...
<div style="background: #f8f9fa; border-left: 4px solid #c0334a; padding: 1.5rem; margin: 2rem 0; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 0.5rem; color: #000;">
    <div style="padding: 0.5rem 0;">
      <a href="#how-to-get-here" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">✈️ How to Get Here</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#when-to-go" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">📅 When to Go</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#where-to-live" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏨 Where to Live</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#currency" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">💰 Currency</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#useful-tips" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">💡 Useful Tips</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#athirapilly-falls" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🌊 Athirapilly Falls</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#alleppy" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🏘️ Alleppy</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#backwaters" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🚣 Kerala Backwaters</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#spa-massage" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">💆 Spa and Massage</a>
    </div>
    <div style="padding: 0.5rem 0;">
      <a href="#kathakali" style="color: #000; text-decoration: underline; font-weight: 500; transition: color 0.2s;">🎭 Kathakali</a>
    </div>
  </div>
</div>
...
#### <a id="where-to-live"></a>Where to live
...
### <a id="useful-tips"></a>Useful Tips
...
## <a id="athirapilly-falls"></a>Athirapilly Falls
...
## <a id="backwaters"></a>Kerala Backwaters
...
## <a id="spa-massage"></a>Spa and Massage
